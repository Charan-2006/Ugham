    ...
    >
      ...
      <div className="container" style={{ position: 'relative', zIndex: 10 }}>
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8rem', alignItems: 'flex-start' }}>
          ...
          >
            <span className="section-label text-radiant" style={{ marginBottom: '2rem', display: 'block' }}>OUR VISION</span>
            <div style={{ position: 'relative' }}>
              <h2 style={{ 
                ...
                background: `radial-gradient(circle at ${mousePos.x}px ${mousePos.y}px, rgba(59, 22, 254, 0.4), transparent 300px)`,
          ...
          {/* Dynamic Column Gap (Virtual Crease) */}
          ...
          >
            <span className="section-label text-radiant" style={{ marginBottom: '2rem', display: 'block' }}>OUR MISSION</span>
            <style>{`
